    ...
    <Navbar sticky="top"  className="bg-dark py-2 flex-grow-1">
      <Container  className="bg-dark px-5 mx-0 d-flex">
        ...
        <Nav className=" flex-grow-1">
          ...
          <LinkContainer to="/">
            <Nav.Link href="#home"  className="text-white  line-left">Home</Nav.Link>
          </LinkContainer>
          
          <LinkContainer to="/restaurants">
            <Nav.Link href="#features"  className="text-white line-left">Restaurants</Nav.Link>
          </LinkContainer>
          <LinkContainer to="/reviews">
            <Nav.Link href="#pricing"  className="text-white line-left">Reviews</Nav.Link>
          </LinkContainer>
        </Nav>
        <Nav>
